...
def main():
    ...
    parser.add_argument('--base_path', type=str, required=True, help='The base path where the folders are located.')
    parser.add_argument('--days_threshold', type=int, required=True, help='The age threshold for folders to be deleted.')
